...
GO_SERVICE_MODULES := services/chat-service services/realtime-service services/gateway-service services/auth-service services/admin-service services/ai-service
